...
ALLOWLIST: set[str] = {
    ...
    "server.py::download_resume_build",
    ...
    "server.py::get_pipeline_stats",
    "server.py::get_profile",
    "server.py::get_profile_keywords",
    "server.py::get_profile_recommendations",
    "server.py::get_profile_sources",
    "server.py::get_resume_build",
    "server.py::get_resume_build_markdown",
    "server.py::list_personas",
    "server.py::list_resume_builds_for_job",
