  ...
  return (
    <section className="bg-gray-900 border border-gray-800 rounded-xl p-6">
      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
        <div>
          <h2 className="text-base font-semibold text-white">Daily Cost</h2>
          <p className="text-[11px] text-gray-500 mt-0.5">
            Stacked by provider · last {days} days
          </p>
        </div>
        <p className="text-[11px] text-gray-500">
          source: <code className="text-gray-400">v_daily_llm_cost</code>
        </p>
      </div>
      ...
      {isEmpty ? (
        <div className="text-center py-10 border border-dashed border-gray-800 rounded-lg">
          <p className="text-sm text-gray-400">No LLM calls logged yet.</p>
          <p className="text-xs text-gray-500 mt-1">
            Cost rows appear here once <code className="text-gray-400">USE_G2_GRAPH=true</code>{' '}
