/**
 * Personas insight surface.
 *
 * Extracted from app/personas/page.tsx so it can be embedded inside the
 * /insights tabbed shell without duplicating data-fetching. Returns just
 * the page body — caller (Insights page) supplies the AppShell + header.
 */
import {
  fetchPersonas,
...
export interface PersonasInsightProps {
  /** Optional render override for the toolbar (used by /insights). */
  showToolbar?: boolean
}

export async function Personas({ showToolbar = true }: PersonasInsightProps = {}) {
